	...
	<div id="dbbt" style="display:none;">
		...
		<div id='divBB' style="font-family:'細明體';">
			...
			<table>
				...
				<tr><td><a align="center">本合約一式二份，買賣雙方各執壹份為憑</a></td></tr>
			...
			<table>
				...
				<tr id="c5_1_a" class="c5_1x">
					<td>
						...
						<a>負責卸貨。出貨須達25噸，未達25噸者須補貼運費至25噸，每噸</a><input type="text" style="width:60px;" id="c5_1_a_c"/><a>元。</a>
					</td>
				</tr>
				<tr id="c5_1_b" class="c5_1x">
					<td>
						...
						<a>甲方負責卸貨。出貨須達25噸，未達25噸者須補貼運費至25噸，每噸</a><input type="text" style="width:60px;" id="c5_1_b_c"/><a>元。</a>
					</td>
				</tr>
				...
				<tr>
					<td>
						<a>　</a><a>(3)</a>
						<a>甲方應備妥足夠容納進貨之場地，及35噸拖車可安全到達之卸貨場地，否則因而產生的其他費用由甲方負擔。</a>
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					<td>
						<a>　(2)</a><a>鋼筋未經送驗合格前，不得加工及使用，否則所衍費用由甲方自行吸收，且該批鋼筋不得辦理退貨。</a>
					</td>
				</tr>
          		<tr>
					<td>
						...
						<br>
						<a>　</a><a>(3)乙方加工完成後通知甲方出貨，甲方需接受乙方於7天內出貨完成。若甲方未能7天內出貨，則補貼乙方成品放置</a>
						<br>
						<a>　</a><a>　  面積廠租費及吊移費，以每平方公尺每日10元補貼乙方。</a>
					</td>
				</tr>
				
				<tr>
					<td>
						<a>9.</a><a>本交易為附條件買賣，依動產交易法第三章之規定，在貨款未付清或票據未兌現之前，標的物之所有權歸屬本公司所</a>
						<br>
						<a>　</a><a>有，買受人無異議，本公司無需經法律程序隨時取回本貨品或貨物清償。</a>
					</td>
				</tr>
				<tr>
					<td>
