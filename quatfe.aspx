	...
	<body>
		...
		<div id='divBB' style="font-family: '細明體';">
			...
			<table>
				<tr>
					<td>
						...
						<div id="b1_1_c_3" class="b1_1_c" style="float:left;">
							<a>每</a><input type="text" style="width:60px;" id="b1_1_c_3a" /><a>噸檢驗</a><input type="text" style="width:60px;" id="b1_1_c_3a1" /><a>支，物性共</a><input type="text" style="width:60px;" id="b1_1_c_3c" /><a>支，化性共</a><input type="text" style="width:60px;" id="b1_1_c_3d" />
				...
				<tr><td><a>　</a><a>(5)</a><a>加工成型部份總料計價，整案承接;不分板料、彎料、直料含及續接柱筋。</a></td></tr>
				...
				<tr>
					<td>
						<a>　</a><a>(4)</a>
						<a>板車料長度12M、14M。超長運費加價14.1M~15M，毎米毎噸加價 </a><input type="text" style="width:60px;" id="b5_1_5_a"/><a>元，超長運費加價15.1M~18M，毎米</a><br>
						<a>　　  毎噸加價</a><input type="text" style="width:60px;" id="b5_1_5_b"/><a>元，不足一米以一米計。 </a>
					</td>
				</tr>
				...
				<tr><td><a>　</a><a>(3)</a><a>買方同意依照合約所定之付款日期及方式繳付價款予賣方，如逾期未付則按總價款之日息萬分之六計算</a></td></tr>
				<tr><td><a>　　 遲延付款之利息，賣方並得據以暫停出貨。</a></td></tr>
				...
				<tr><td>
                        <a>　(3)買賣雙方對交貨、加工、材質有所爭議時，雙方應先協調檢驗及驗收方式，如買方未經賣方同意而自行</a><br>
						<a>　</a><a> 　扣款，則賣方有權終止合約。</a>
				</td></tr>
		...
		<div id='divCC' style="font-family: '細明體';">
			...
			<table>
				...
				<tr>
					<td>
						<a>　</a><a>(4)</a>
						<a>板車料長度12M、14M。超長運費加價14.1M~15M，毎米毎噸加價 </a><input type="text" style="width:60px;" id="c5_1_5_a"/><a>元</a><br>
						<a>　　 ，超長運費加價15.1M~18M，毎米毎噸加價</a><input type="text" style="width:60px;" id="c5_1_5_b"/><a>元，不足一米以一米計。 </a>
					</td>
				</tr>
				<tr>
					<td>
						<a>　</a><a>(5)</a><a>板車承裝加工成型料整台運費每噸另加50元。 </a>
					</td>
				</tr>
				...
				<tr><td><a>　(3)</a><a>買賣雙方對交貨、加工、材質有所爭議時，雙方應先協調檢驗及驗收方式，如買方未經賣方同意而自行</a></td></tr>
				<tr><td><a>　   </a><a> 　扣款，則賣方有權終止合約。</a></td></tr>
          		<tr>
					<td>
						<a>8.</a><a>(1)本合約之各項材料單價，不論市面價款之漲落，買賣雙方均不得提出增減價格及數量之要求。</a><br>
						<a>　</a><a>(2)賣方所提供材料於買方各期貨款支付或票據兌現前賣方仍保有所有權。</a><br>
