            ...
            <div class="dview" id="dview">
                <table class="tview" id="tview" >
                    <tr>
                        ...
                        <td align="center" style="width:25%"><a id='vewUno'> </a></td>
                    </tr>
                    <tr>
        ...
        <div class='dbbs'>
            <table id="tbbs" class='tbbs'>
                ...
                <tr style='background:#cad3ff;'>
                	...
                	<td>
                		<input id="txtVccno.*" type="text" class="txt" style="width:70%;"/>
                		<input id="txtVccnoq.*" type="text" class="txt" style="width:25%;"/>
            		</td>
                </tr>
            </table>
        </div>
