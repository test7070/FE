	...
	<head>
		...
		<script type="text/javascript">
            ...
            function q_seekStr() {
                ...
                var t_where = " 1=1 " + q_sqlPara2("noa", t_noa)+ q_sqlPara2("datea", t_bdate, t_edate) + q_sqlPara2("salesno", t_salesno) + q_sqlPara2("tggno", t_tggno) ;
				if (t_tgg.length>0)
	...
	<body>
		<div style='width:400px; text-align:center;padding:15px;' >
			<table id="seek"  border="1"   cellpadding='3' cellspacing='2' style='width:100%;' >
				<tr class='seek_tr'>
					<td   style="width:35%;" ><a id='lblDatea'>日     期</a></td>
					<td style="width:65%;  ">
				...
				<tr class='seek_tr'>
					<td class='seek'  style="width:20%;"><a id='lblSalesno'>業務編號</a></td>
					<td>
					<input class="txt" id="txtSalesno" type="text" style="width:215px; font-size:medium;" />
					</td>
				</tr>
				<tr class='seek_tr'>
					<td class='seek'  style="width:20%;"><a id='lblSales'>業 務 員</a></td>
					<td>
